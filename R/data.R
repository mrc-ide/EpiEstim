...
#' influenza amongst children in a school in New York city during the 2009 H1N1 
...
#' \describe{
#'   \item{incidence}{a dataframe with 14 lines containing dates in first 
#'   column, and daily incidence in second column ,}
#'   \item{si_data}{a dataframe containing data on the generation time for 16 
#'   pairs of infector/infected individuals
#'   (see references and see argument \code{si_data} of function 
#'   \code{estimate_R} for details on columns) }
#' }
...
#' assuming a shifted Gamma distribution with mean 2.6 days, standard deviation 
#' 1.5 days and shift 1 day (see references).
#'
#' @name Flu1918
#' @docType data
#' @format A list of two elements:
...
#' (ARI, defined as at least two symptoms among fever, cough, sore throat, and 
#' runny nose)
...
#'   with 32 lines containing dates in first column, and daily incidence in
#'   second column (Cauchemez et al., 2011),} \item{si_distr}{a vector
#'   containing a set of 12 probabilities (Ferguson et al, 2005),} 
#'   \item{si_data}{a dataframe with 16 lines giving serial interval patient
#'   data collected in a household study in San Antonio, Texas throughout the
#'   2009 H1N1 outbreak (Morgan et al., 2010). } }
#' @source { Cauchemez S. et al. (2011) Role of social networks in shaping
...
#' 
#' This data set gives: 1/ the daily incidence of onset of symptoms in Hallegoch
#' (Germany) during the 1861 measles epidemic (see source and references), 2/
#' the discrete daily distribution of the serial interval for measles, assuming
#' a shifted Gamma distribution with mean 14.9 days, standard deviation 3.9 days
#' and shift 1 day (see references).
#' 
#' @name Measles1861
#' @docType data
#' @format A list of two elements:
...
#' 
#' This data set gives: 1/ the daily incidence of onset of symptoms in Hong Kong
#' during the 2003 severe acute respiratory syndrome (SARS) epidemic (see source
#' and references), 2/ the discrete daily distribution of the serial interval
#' for SARS, assuming a shifted Gamma distribution with mean 8.4 days, standard
#' deviation 3.8 days and shift 1 day (see references).
#'
#' @name SARS2003
#' @docType data
#' @format A list of two elements:
...
#' 
#' This data set gives: 1/ the daily incidence of onset of symptoms in Kosovo
#' during the 1972 smallpox epidemic (see source and references), 2/ the
#' discrete daily distribution of the serial interval for smallpox, assuming a
#' shifted Gamma distribution with mean 22.4 days, standard deviation 6.1 days
#' and shift 1 day (see references).
#'
#' @name Smallpox1972
#' @docType data
...
#' 
#' This data set gives: 1/ the daily incidence of onset of symptoms in a mock
#' outbreak of rotavirus , 2/ mock observations of symptom onset dates for 19
#' pairs of infector/infected individuals.
#'
#' @name MockRotavirus
#' @docType data
...
#'   \item{si_distr}{a dataframe containing a set of 19 observations; each 
#'   observation corresponds to a pair of infector/infected individuals. EL and 
...
#' 
#' This data set gives: 1/ the daily incidence of onset of symptoms of 
#' laboratory confirmed human infections with MERS-CoV in Saudi Arabia 
#' between the beginning of July 2014 and the end of December 2015, and 
#' 2/ estimates of the mean and standrad deviation of the serial interval 
#' for MERS.
#'
#' @name mers_2014_15
#' @docType data
#' @format A list of two elements:
#' \describe{
#'   \item{incidence}{a dataframe containing 495 days of observations with dates
#'   in the first column, and number of local (2nd column) and imported 
#'   (3rd column) cases of MERS,}
#'   \item{si}{a list of estimates of the mean (mean_si) and standard deviation
...
#' \code{\link{estimate_R}}. The serial interval parameters were those 
