...
#'
#' Transforms outputs of [coarseDataTools::dic.fit.mcmc()] to the correct format
#' for input into [estimate_R()]
#'
#' @param x An object generated by function
#' [coarseDataTools::dic.fit.mcmc()], containing posterior estimates of the
...
#' shifted by 1).  If not present, computed automatically from `x`.
