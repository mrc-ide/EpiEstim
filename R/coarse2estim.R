...
#' @param dist The parametric distribution used when estimating the serial interval. Should be one of "G" (Gamma), "E" (Erlang), "off1G" (Gamma shifted by 1), "W" (Weibull), or "L" (Lognormal).  If not present, computed automatically from \code{x}.
