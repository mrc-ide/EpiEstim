...
knitr::include_graphics("/Users/rebeccanash/Desktop/EpiEstim_Vignette_Directory/Illustration_of_process.png")
```
...
```{r, echo=FALSE, out.width="90%"}
knitr::include_graphics("/Users/rebeccanash/Desktop/EpiEstim_Vignette_Directory/Serial interval with uncertainty.png")
```
</div>
</div>
...
knitr::include_graphics("/Users/rebeccanash/Desktop/EpiEstim_Vignette_Directory/interval-censored example.png",
...
library(EpiEstim) # contains the Flu2009 example dataset
library(ggplot2)  # a package that aids data visualisation
```
...
knitr::include_graphics("/Users/rebeccanash/Desktop/EpiEstim_Vignette_Directory/Renewal equation v2.png")
```
...
knitr::include_graphics("/Users/rebeccanash/Desktop/EpiEstim_Vignette_Directory/Infector-infected exact.png")
```
</p>
</div>
</div>
...
<p align="center">
```{r, echo=FALSE, out.width="40%"}
knitr::include_graphics("/Users/rebeccanash/Desktop/EpiEstim_Vignette_Directory/Infector-infected intervals 2.png")
```
</p>
</div>
</div>
...
<p align="center">
```{r, echo=FALSE, out.width="40%"}
knitr::include_graphics("/Users/rebeccanash/Desktop/EpiEstim_Vignette_Directory/Weekly sliding windows.png")
```
</p>
</div>
</div>
...
```{r, echo=FALSE}
linelist <- read.csv("~/Desktop/EpiEstim_Vignette_Directory/Ebola_linelist.csv")
```
...
```{r, fig.width=6}
library(incidence) # load the incidence package
...
knitr::include_graphics("/Users/rebeccanash/Desktop/EpiEstim_Vignette_Directory/Anne's figure.png")
```
...
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("/Users/rebeccanash/Desktop/EpiEstim_Vignette_Directory/Time-varying reporting 3.png")
```
