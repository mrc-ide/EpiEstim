...
test_that("draw_epsilon produces expected results with 2 variants", {
  n_v <- 2 # 2 variants
  n_loc <- 4 # 4 locations
...
test_that("draw_R produces expected results with 2 variants", {
  n_v <- 2 # 2 variants
  n_loc <- 4 # 4 locations
  T <- 100 # 100 time steps
...
test_that("estimate_joint produces expected results with 2 variants", {
  n_v <- 2 # 2 variants
  n_loc <- 3 # 3 locations
  T <- 100 # 100 time steps
