...
test_that("Example 1 matches saved output", {
  out <- EstimateR(Flu2009$incidence, method="non_parametric_si",
...
test_that("Example 2 matches saved output", {
  ...
  out <- EstimateR(I, method = "parametric_si",
...
test_that("Example 3 matches saved output", {
  ...
  out <- EstimateR(Flu2009$incidence, method="parametric_si",
...
test_that("Example 4 matches saved output", {
  ...
  out <- EstimateR(Flu2009$incidence, method="uncertain_si",
